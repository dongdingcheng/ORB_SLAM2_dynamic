...
#include"dynamic/dynamic/dynamic.h"
...
public:
    std::shared_ptr<detectDynamic> mpDetectDynamic;
    void setDynamic(shared_ptr<detectDynamic> detectDynamic )
    {
        mpDetectDynamic=detectDynamic;
    }
