...
// 9. 线程之间传递指针 Set pointers between threads
          ...
          string  binpath="/home/divine/LearnVIORB/dynamic/detect/model/myCal.bin";
          mpDetectDynamic=shared_ptr<detectDynamic>(new detectDynamic(5000,binpath,1024,512));
          mpTracker->setDynamic(mpDetectDynamic);
	  }
